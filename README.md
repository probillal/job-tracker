1. What is the difference between getElementById, getElementsByClassName, and querySelector / querySelectorAll?
   Ans: getElementById- return only one element, search by Id
   getElementsByClassName- As same class return by more elements, give html collection like array but not array.
